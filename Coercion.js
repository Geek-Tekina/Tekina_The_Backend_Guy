...
); // so this is a case of number - object. See docs for ToNumber(object), here two functions can be declared and they are called in different order as per the hint. Fnc - 1. valueof() & 2. toString() [they r not abstract ops]
// 6.
console.log(
  2 -
    {
